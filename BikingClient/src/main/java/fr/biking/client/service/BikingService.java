 ...
 * 
 */
@WebServiceClient(name = "BikingService", targetNamespace = "http://tempuri.org/", wsdlLocation = "http://localhost:8733/BikingServer/Service/wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8733/BikingServer/Service/wsdl");
